<div class="eventsTags index">
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $eventsTag['EventsTag']['id']; ?>&nbsp;</td>
		<td>
		...
		<td><?php echo $eventsTag['EventsTag']['agenda']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $eventsTag['EventsTag']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $eventsTag['EventsTag']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $eventsTag['EventsTag']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $eventsTag['EventsTag']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
